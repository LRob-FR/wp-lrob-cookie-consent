                ...
                <div class="lrob-cc-banner-fields">
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr><th><?php esc_html_e('Accept button', 'lrob-cookie-consent'); ?></th>
                            <td><input type="text" data-field="text_accept" name="<?php echo $name('text_accept'); ?>" value="<?php echo esc_attr((string) $o['text_accept']); ?>" placeholder="<?php echo esc_attr($text_defaults['accept']); ?>" /></td></tr>
                        ...
                        <tr><th><?php esc_html_e('Customize button', 'lrob-cookie-consent'); ?> <?php $help(__('Shown only when category options are hidden behind a button (see Layout). It reveals the per-category choices.', 'lrob-cookie-consent')); ?></th>
                            <td><input type="text" data-field="text_customize" name="<?php echo $name('text_customize'); ?>" value="<?php echo esc_attr((string) $o['text_customize']); ?>" placeholder="<?php echo esc_attr($text_defaults['customize']); ?>" /></td></tr>
